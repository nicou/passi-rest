...
public class WorksheetAnswer implements Serializable {
	...
	public WorksheetAnswer(int answerID, int worksheetID, String username, String planningText,
